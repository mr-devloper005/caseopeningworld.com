...
export const pagesContent = {
  home: {
    metadata: {
      ...
      description: 'Browse verified businesses, services, spaces, and location-based opportunities through a cleaner listing-first experience.',
      openGraphTitle: 'Business listings and local discovery',
      openGraphDescription: 'Discover verified businesses, services, and local opportunities through a calmer, listing-first experience.',
      keywords: ['business listings', 'local business directory', 'classifieds', 'business discovery'],
    },
    hero: {
      badge: 'Business & listing discovery',
      title: ['A smarter way to discover', 'local businesses and listings.'],
      description: 'Browse verified businesses, services, spaces, and location-based opportunities through a cleaner, listing-first discovery experience.',
      primaryCta: { label: 'Browse listings', href: '/listing' },
      secondaryCta: { label: 'View classifieds', href: '/classified' },
      searchPlaceholder: 'Search businesses, services, and listings',
      focusLabel: 'Focus',
      featureCardBadge: 'newest listings',
      featureCardTitle: 'Newly added businesses shape the homepage.',
      featureCardDescription: 'Recently listed businesses and services stay at the center of the experience without changing any core platform behavior.',
    },
    intro: {
      badge: 'About the platform',
      title: 'Built for finding, comparing, and connecting with local businesses.',
      paragraphs: [
        'This site brings together verified business listings, classifieds, and supporting resources so visitors can move naturally between different ways of discovering local businesses.',
        'Instead of separating listings, offers, and supporting content into disconnected surfaces, the platform keeps them connected in one place with consistent navigation and easier exploration.',
        'Whether someone starts with a listing, a classified ad, an article, or a profile page, they can keep discovering related businesses and services without friction.',
      ],
      sideBadge: 'At a glance',
      sidePoints: [
        'Listing-first homepage with stronger emphasis on verified businesses and services.',
        'Connected sections for listings, classifieds, articles, and supporting resources.',
        'Cleaner browsing rhythm designed to make local discovery feel easier.',
    ...
    cta: {
      ...
      title: 'Explore listings, classifieds, and resources through one connected experience.',
      description: 'Move between business listings, classified ads, and supporting resources through one clearer and more connected discovery system.',
      primaryCta: { label: 'Browse Listings', href: '/listing' },
