...
// Shared editorial-magazine palette — every task inherits this; only the
// kicker/note copy differs. Serif display + clean sans body, white surfaces,
// a confident cyan accent and hairline cool-gray borders.
const base = {
  dark: false,
